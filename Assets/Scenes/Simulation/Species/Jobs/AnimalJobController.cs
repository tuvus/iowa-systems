...
public class AnimalJobController : BasicJobController {
    ...
    int eddibleCount;
    NativeArray<Eddible.Data> eddibles;
    ...
    public override JobHandle StartJob() {
        ...
        job = AnimalUpdateJob.BeginJob(animalActions,animals,animalCount, speciesFullFood, speciesMaxFood, speciesSightRange, speciesEatRange, speciesSmellRange,
             availableMaleMateCount,availableMaleMatePositions,availableFemaleMateCount, availableFemaleMatesPositions,eddibleCount,eddibles,predatorCount, predators);
        return job;
    }
    ...
    public override void Allocate() {
        ...
        eddibles = new NativeArray<Eddible.Data>(10000, Allocator.Persistent);
