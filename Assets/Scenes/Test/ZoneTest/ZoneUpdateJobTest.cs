...
public struct ZoneUpdateJobTest : IJobParallelFor {
    ...
    public static JobHandle BeginJob(NativeArray<float3> zonePositions, NativeParallelMultiHashMap<int, int>.ParallelWriter neiboringZones, int maxNeiboringZones, float distance) {
